    ...
    <div className="container flex space-x-8">
      <div className="flex flex-1 flex-col items-center">
        ...
        <div className="px-4 indent-8 text-sm leading-7 sm:text-base sm:leading-10">
          ...
          <p>
            睿朴麟的产品研发和解决方案设计围绕制造业广义供应链智能协同展开，既关注企业内部职能间业财联动又关注供应链生态组织间运营及发展协同，这是我们的突出特色。精益、增值导向贯穿工作始终，我们在融入了必要的物联网、大数据、人工智能、区块链等现代信息技术手段的同时，更注重实效性和经济性。我们在企业职能业务勾稽关系、信息化投入、相关方协同困惑等方面做出了很多精心的设计与安排，提供数字化产品只是我们任务的一部分，更多的在于为企业带来怎样的业务变革，而这些变革必然是为企业带来增值效应、提升其竞争力的。
          </p>
          <p>
      ...
      <div className="relative my-auto hidden size-[500px] shrink-0 lg:flex">
        ...
        <div className={cn('absolute right-[30%] bottom-[18%]', styles.mapCircle)}>
          <span className="absolute left-4 whitespace-nowrap text-nowrap">深圳</span>
        </div>
        <div className={cn('absolute right-[39%] top-[54%]', styles.mapCircle)}>
          <span className="absolute left-4 whitespace-nowrap text-nowrap">西安</span>
        </div>
      </div>
    </div>
  )
